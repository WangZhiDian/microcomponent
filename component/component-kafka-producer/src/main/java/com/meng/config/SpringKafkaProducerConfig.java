...
@ConditionalOnProperty(name = "system.bean.switch.kafka.producer", havingValue = "true", matchIfMissing = true)
public class SpringKafkaProducerConfig {
    ...
    private Map<String, Object> toProperties() {
        ...
        if (this.sasl) {
            notNullAdd(properties, SslConfigs.SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_CONFIG,
