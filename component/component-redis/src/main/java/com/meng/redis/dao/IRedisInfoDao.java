...
public interface IRedisInfoDao {
     ...
     * @return boolean :
     */
    boolean saveStrInfoNx(String key, String value);
     ...
     * @return String :
     */
    String getSetStrInfo(String key, String value);
     ...
     * @return boolean :
     */
    boolean trimStrInfoFromList(String listName, long beginIndex, long endIndex);
    ...
    /**
     * list< string> scan map item info
     *
     * @param key     :
     * @param pattern :
     * @param count   :
     * @return :
     */
    List<String> scanMapItemInfo(String key, String pattern, long count);
     ...
     * @return Map<String, String> :
     */
    Map<String, String> scanMapInfo(String key, String pattern, long count);
     ...
     * @return long :
     */
    long getExtremeScoreFromSortSet(String setName, boolean desc);
     ...
     * @return :
     */
    boolean deleteStrInfoFromSortSet(String setName, long beginIndex, long endIndex);
     ...
     */
    Set<ValueScoreInfo> scanValueScoreInfoFromSortSet(String setName, String pattern, long count);
